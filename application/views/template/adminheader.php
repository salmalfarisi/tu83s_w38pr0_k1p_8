...
<body>
	<div class="row headers">
		...
		<div class="header-icons col-2 offset-9">
                ...
                <a href="<?php echo base_url('admin');?>" class="btn" style="background:#FF6600;color: white">LOG OUT</a>                
        </div>
	</div>
	<div class="row headers">
		<div class="col-4 offset-6 a1 hurufproduk" style="left: -100px"><b>SISTEM PENGELOLAAN PRODUK</b></div>
	</div>
	<div class="row headers">
		<div class="col-1 offset-3"><a class="hurufproduk linkss " href="<?php echo base_url('admin/dataproduk');?>"><b>PRODUK</b></a></div>
		<div class="col-1 offset-2"><img src="<?php echo base_url('assets/contoh home/pic/mid.png')?>" style="height: 80%"></div>
		<div class="col-1 offset-2"><a class="hurufproduk linkss" href="<?php echo base_url('admin/datapemesanan');?>"><b>PEMESANAN</b></a></div>
	</div> 
